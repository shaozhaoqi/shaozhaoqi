...
public class HttpclientUtils {
    ...
    public static String doPost(String url, Map<String, String> parameterMap) {
        ...
        try {
            ...
            e.printStackTrace();
            //服务器连接超时异常
            return JSON.toJSONString(ServerResponse.error(ResponseEnum.SERVER_CONNECT_ERROR));
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            return JSON.toJSONString(ServerResponse.error(ResponseEnum.SERVER_BUSYNESS));
        } catch (IOException e) {
            e.printStackTrace();
            return JSON.toJSONString(ServerResponse.error(ResponseEnum.SERVER_ERROR));
        }finally {
            if(response != null){
                try {
                    response.close();
